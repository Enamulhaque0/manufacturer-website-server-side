...
const uri = "mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.vh8m10a.mongodb.net/?retryWrites=true&w=majority";
...
const run = async () => {
    ...
    try {
        ...
        const productCollenction = client.db("ass-12-server").collection("products");
        const userCollenction = client.db("ass-12-server").collection("users");
        const reviewCollenction = client.db("ass-12-server").collection("reviews");
        const orderCollenction = client.db("ass-12-server").collection("orders");
        const paymentCollenction = client.db("ass-12-server").collection("payments");
